...
contract DeployMainnet is Script {
    ...
    function _writePendingArtifact(
        ...
        string memory deployment = vm.serializeString("deployment", "network", "bot-chain-mainnet");
        deployment = vm.serializeUint("deployment", "chainId", TARGET_CHAIN_ID);
        deployment = vm.serializeString("deployment", "rpcUrl", "https://rpc.botchain.ai");
        deployment = vm.serializeString("deployment", "explorerUrl", "https://scan.botchain.ai");
        ...
        vm.writeJson(
            deployment,
            string.concat(vm.projectRoot(), "/script/deployments/bot-chain-mainnet.pending.json")
        );
    }
}
